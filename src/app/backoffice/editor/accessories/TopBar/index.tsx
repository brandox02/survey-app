   ...
   return (
      <div className="border border-gray-300 bg-white py-3 flex items-center justify-between">
         <div className="flex items-center gap-2 w-9/12 mr-5">
            ...
            <input className="font-bold text-xl w-full text-emerald-700 outline-none hover:border-emerald-700 hover:border-2 rounded-lg px-1 py-1" value={title} onChange={e => setTitle(e.target.value)} />
         </div>
